...
import '../provider/admin_markets_provider.dart';
...
class _MarketsScreenState extends State<MarketsScreen> {
  late final AdminMarketsProvider _provider;
  final _payloadController = TextEditingController();

  @override
  void initState() {
    super.initState();
    _provider = AdminMarketsProvider()..load();
  }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(context.l10n.markets),
          leading: IconButton(
            icon: const HugeIcon(icon: HugeIcons.strokeRoundedArrowLeft01),
            onPressed: () => context.go('/dashboard'),
          ),
          actions: [
            Consumer<AdminMarketsProvider>(
        ...
        body: Consumer<AdminMarketsProvider>(
          builder: (context, provider, _) {
            return ListView(
              ...
              children: [
                ...
                JsonPreviewCard(
                  title: context.l10n.regionPresets,
                  json: provider.regionPresets,
                ...
                Text(
                  context.l10n.updateRegionPresets,
